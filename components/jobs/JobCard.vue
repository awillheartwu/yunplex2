<template>
  <button
    class="w-full text-left bg-surface border border-[var(--border-primary)] rounded-xl p-5 hover:border-[var(--border-secondary)] hover:bg-surface-elevated transition-all cursor-pointer group"
    @click="$emit('select')"
  >
